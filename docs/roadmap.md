...
| 0.4.3-b Web koşum sayfası kapsamı söylemiyor | `layers` (hızlı mod), `skipped` ve `partial` hosted sayfada hiç gösterilmiyor: 3 denemelik bir erken uyarı tam ölçüm gibi görünür, atlanan vaka sessizce yok olur. CLI üçünü de manşette söylüyor (decisions.md 2026-09-08, 2026-09-09) | bekliyor — ilk kazananlı koşumu yayımlamadan önce |
