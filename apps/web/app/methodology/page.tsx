    ...
    <Shell>
      ...
      <section className="section-major">
        ...
        <p className="section-lede">
          ...
          the two runs, {caseSet.counts.unavailable} could not be read at all, and exactly
          one changed — the case set.
        </p>
        ...
        {blindPin === undefined ? null : (
          <Callout tone="warning" title={`Pin ${blindPin.pin} was not measured`}>
            ...
            placeholder rather than a value. A placeholder is identical in every run, and
            counting that as <em>held</em> would hand the comparison a guarantee nobody
            measured — the same mistake this page is about. Assay reports it as a third
            state, and a comparison resting on an unread pin returns{' '}
        ...
        <p className="section-note">
          ...
          . Recall is unchanged in both. The whole difference is in how the negative cases
          were cut.
        </p>
        ...
        <Callout tone="info" title="What this changes about reading a result">
          A trigger suite that passes every case is a statement about the suite as much as
          about the skill. Assay enforces that a case set contains a negative and a near
          neighbour; it cannot yet check that the near neighbour is near along the right
          axis. Until it can, a clean sheet is a prompt to look at the negatives, not a
          reason to stop.
        </Callout>
      </section>
      ...
      <section className="section-major">
        ...
        <p className="section-lede">
          Trigger accuracy answers one question: did it fire? A second run asked the next
          one — once it fired, did the work get finished? Across{' '}
          {layers.crosstab.firedDone +
            layers.crosstab.firedMissing +
            layers.crosstab.quietDone +
            layers.crosstab.quietMissing}{' '}
          attempts of the same skill, the two answers turned out to be mutually exclusive.
        </p>
        ...
        <p className="section-note">
          No attempt landed in either of the other two cells. Where the skill engaged, the
          file was never written; where it stayed out of the way, the file was always
          written.
        </p>
        ...
        <p className="section-note">
          ...
          on its strongest case and called the skill exemplary. The artefact layer reports{' '}
          <strong>
        ...
        <div className="mt-12">
          ...
          <p className="section-note">
            ...
            {layers.trace.writes.length === 0 ? 'empty' : layers.trace.writes.join(', ')}.
      ...
      <section className="section-minor">
        ...
        <p className="section-lede">
          ...
          <code className="code">{designDoc.caseId}</code> except for the final paragraph,
          which asks for a file on disk. Nothing else differs — same run, same record, so
          all {caseSet.counts.total} pins are recorded once and cover both cases.
        </p>
        <div className="split mt-10">
          ...
          <article className="split-half">
            <p className="col-label">Same prompt, plus &ldquo;save it to out/…&rdquo;</p>
        ...
        <p className="section-note">
          ...
          the person reporting it: the pins are recorded once and cover both. Running the
          control separately would have produced a second record with its own environment
          hash, and the claim would have rested on an assurance instead of a pin.
        </p>
      </section>
      ...
      <section className="section-minor">
        ...
        <p className="section-lede">
          The completion layer asserts that a file exists, parses, and matches a pattern.
          It cannot assert where the content came from. One case in a third run makes the
          gap visible.
        </p>
        <dl className="limit-grid mt-8">
          <div className="limit">
            ...
            <dd className="limit-body">
              attempts produced <code className="code">out/run.txt</code>, the file meant
              to hold the output of a test run
            </dd>
          </div>
          <div className="limit">
            <dt className="limit-figure">
        ...
        <p className="section-note">
          ...
          <code className="code">file_content_matches</code> can tell you a plausible file
          is there; they cannot tell a recorded run from a well-formed guess. The same
          boundary is why side-effect claims return{' '}
        ...
        <Callout tone="warning" title="Stated, not fixed">
          This is a ceiling in the tool as it stands today, not in the skills it measured.
          It is written here for the same reason a run reports{' '}
      ...
      <section className="section-minor section-last">
        ...
        <p className="section-lede">
          Every figure on this page is read out of a stored run record. None is written by
          hand.
        </p>
        ...
        <p className="section-note">
          ...
          <code className="code">examples/measurements/</code>; the long-form reports are
          in <code className="code">docs/measurements.md</code>.
        </p>
        <p className="mt-8">
