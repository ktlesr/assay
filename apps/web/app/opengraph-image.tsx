...
async function specimen(): Promise<{
  ...
  try {
    ...
    const worst =
      cases.filter((c) => c.failed > 0).sort((a, b) => (a.passRate.rate ?? 1) - (b.passRate.rate ?? 1))[0] ??
      cases[0]
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 20 }}>
          ...
          <div style={{ display: 'flex', fontSize: 40, letterSpacing: '-0.01em' }}>Assay</div>
          <div
            style={{
              display: 'flex',
              marginLeft: 'auto',
        ...
        {/* İddia */}
        <div style={{ display: 'flex', fontSize: 68, lineHeight: 1.05, marginTop: 48, maxWidth: 900 }}>
        ...
        {found === null ? (
          ...
          <>
            ...
            <div style={{ display: 'flex', marginTop: 'auto', flexDirection: 'column' }}>
              <div style={{ display: 'flex', height: 1, background: RULE, marginBottom: 26 }} />
              <div style={{ display: 'flex', alignItems: 'baseline', gap: 16 }}>
                ...
                <div style={{ display: 'flex', fontSize: 30, fontFamily: 'monospace', color: MUTED }}>
                  {found.caseId}
                </div>
              </div>
              <div
